    ...
    <div class="menu_section">
        <ul class="nav side-menu">
            ...
            <li><a><i class="fa fa-folder"></i> Penjadwalan <span class="fa fa-chevron-down"></span></a>
                ...
                <ul class="nav child_menu">
                      <li><a href="<?php echo base_url('pengajuan'); ?>">Pengajuan</a></li>
                 
                      <li><a href="<?php echo base_url('ajuan_mhs'); ?>">Daftar Pengajuan</a></li>
                      <li><a href="<?php echo base_url('#'); ?>">Verifikasi</a></li>
                      <li><a href="<?php echo base_url('tb_transaksi'); ?>">Transaksi</a></li>
                </ul>
            </li>          
        </ul>
    </div>
